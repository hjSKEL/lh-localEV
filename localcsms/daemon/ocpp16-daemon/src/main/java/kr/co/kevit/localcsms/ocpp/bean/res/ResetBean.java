...
public class ResetBean implements ResponderBean {
    ...
    private static final Logger log = LoggerFactory.getLogger(ResetBean.class);
    ...
    public void handle(String cpCsId, JsonNode payload, String uniqueId) throws Exception {
        kr.co.kevit.ocpp16.response.Reset response =
                objectMapper.treeToValue(payload, kr.co.kevit.ocpp16.response.Reset.class);
        log.debug("ResetBean cpCsId={} getStatus={}", cpCsId, response.getStatus());
