...
@Component("ClosePeriodicEventStream")
public class ClosePeriodicEventStreamBean implements ControlerBean {

    private static final Logger LOGGER = LoggerFactory.getLogger(ClosePeriodicEventStreamBean.class);
    ...
    public ObjectNode control(String cpCsId, OcppMessage msg) throws Exception {
        ...
        //
        LOGGER.debug("ClosePeriodicEventStreamBean CSID : {}", cpCsId);
