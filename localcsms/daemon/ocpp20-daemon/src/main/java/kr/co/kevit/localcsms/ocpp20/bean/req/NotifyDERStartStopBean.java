...
public class NotifyDERStartStopBean implements ControlerBean{
    ...
    public ObjectNode control(String cpCsId, OcppMessage msg) throws Exception {
        ...
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("NotifyDERStartStopBean text : {}", text);
        }
        kr.co.kevit.ocpp201.request.NotifyDERStartStop obj = objectMapper.readValue(text,kr.co.kevit.ocpp201.request.NotifyDERStartStop.class);
