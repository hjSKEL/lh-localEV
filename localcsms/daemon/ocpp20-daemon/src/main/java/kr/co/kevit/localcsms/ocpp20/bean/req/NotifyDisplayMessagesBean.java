 ...
 * @since 2022. 2. 21.
 */
@Component("NotifyDisplayMessages")
public class NotifyDisplayMessagesBean implements ControlerBean{
    ...
    public ObjectNode control(String cpCsId, OcppMessage msg) throws Exception {
        ...
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("NotifyDisplayMessagesBean text : {}", text);
        }
//        kr.co.kevit.ocpp201.request.NotifyDisplayMessages obj = objectMapper.readValue(text,kr.co.kevit.ocpp201.request.NotifyDisplayMessages.class);
        
        
        kr.co.kevit.ocpp201.response.NotifyDisplayMessages response = new kr.co.kevit.ocpp201.response.NotifyDisplayMessages();
