...
@Component("ChangeTransactionTariff")
public class ChangeTransactionTariffBean implements ResponderBean {

    private static final Logger log = LoggerFactory.getLogger(ChangeTransactionTariffBean.class);
