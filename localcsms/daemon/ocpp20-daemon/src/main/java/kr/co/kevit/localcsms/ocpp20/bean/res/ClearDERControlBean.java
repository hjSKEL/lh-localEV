...
@Component("ClearDERControl")
public class ClearDERControlBean implements ResponderBean {

    private static final Logger log = LoggerFactory.getLogger(ClearDERControlBean.class);
