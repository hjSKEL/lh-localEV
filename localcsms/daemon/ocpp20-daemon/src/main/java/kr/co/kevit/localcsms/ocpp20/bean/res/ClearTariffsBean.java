...
@Component("ClearTariffs")
public class ClearTariffsBean implements ResponderBean {

    private static final Logger log = LoggerFactory.getLogger(ClearTariffsBean.class);
