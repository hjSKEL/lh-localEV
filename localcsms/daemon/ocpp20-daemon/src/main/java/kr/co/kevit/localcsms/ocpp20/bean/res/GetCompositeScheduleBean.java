...
@Component("GetCompositeSchedule")
public class GetCompositeScheduleBean implements ResponderBean {
    ...
    public void handle(String cpCsId, JsonNode payload, String uniqueId) throws Exception {
        kr.co.kevit.ocpp201.response.GetCompositeSchedule response =
                objectMapper.treeToValue(payload, kr.co.kevit.ocpp201.response.GetCompositeSchedule.class);
        log.debug("GetCompositeScheduleBean cpCsId={} status={}", cpCsId, response.getStatus());
    }
}
