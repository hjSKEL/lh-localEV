...
public class RequestBatterySwapBean implements ResponderBean {
    ...
    public void handle(String cpCsId, JsonNode payload, String uniqueId) throws Exception {
        kr.co.kevit.ocpp201.response.RequestBatterySwap response =
                objectMapper.treeToValue(payload, kr.co.kevit.ocpp201.response.RequestBatterySwap.class);
        log.debug("RequestBatterySwapBean cpCsId={} uniqueId={}", cpCsId, uniqueId);
    }
}
