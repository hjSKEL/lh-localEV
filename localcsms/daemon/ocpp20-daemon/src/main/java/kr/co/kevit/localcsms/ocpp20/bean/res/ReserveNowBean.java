...
public class ReserveNowBean implements ResponderBean {
    ...
    public void handle(String cpCsId, JsonNode payload, String uniqueId) throws Exception {
        kr.co.kevit.ocpp201.response.ReserveNow response =
                objectMapper.treeToValue(payload, kr.co.kevit.ocpp201.response.ReserveNow.class);
        log.debug("ReserveNowBean cpCsId={} status={}", cpCsId, response.getStatus());
    }
}
