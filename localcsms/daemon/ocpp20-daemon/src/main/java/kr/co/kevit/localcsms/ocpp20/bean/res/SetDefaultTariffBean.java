...
@Component("SetDefaultTariff")
public class SetDefaultTariffBean implements ResponderBean {

    private static final Logger log = LoggerFactory.getLogger(SetDefaultTariffBean.class);
