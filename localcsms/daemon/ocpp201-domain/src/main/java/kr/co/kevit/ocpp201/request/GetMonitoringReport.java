...
import kr.co.kevit.ocpp201.enumtype.MonitoringCriterionEnumType;
 ...
 * @since 2020. 1. 15.
 */
public class GetMonitoringReport {
     ...
     */
    private List<MonitoringCriterionEnumType> monitoringCriteria;
    ...
    public List<MonitoringCriterionEnumType> getMonitoringCriteria() {
