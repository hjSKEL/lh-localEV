...
import kr.co.kevit.ocpp201.enumtype.TariffChangeStatusEnumType;
...
public class ChangeTransactionTariff {
     ...
     * required
     */
    private TariffChangeStatusEnumType status;

    private StatusInfoType statusInfo;

    private Map<String, Object> customData;

    public TariffChangeStatusEnumType getStatus() {
        return status;
    }

    public void setStatus(TariffChangeStatusEnumType status) {
        this.status = status;
    }
