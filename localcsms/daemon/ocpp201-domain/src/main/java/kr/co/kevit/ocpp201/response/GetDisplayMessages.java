...
import kr.co.kevit.ocpp201.enumtype.GetDisplayMessagesStatusEnumType;
...
public class GetDisplayMessages {
     ...
     * required
     */
    private GetDisplayMessagesStatusEnumType status;
     ...
     * @return status
     */
    public GetDisplayMessagesStatusEnumType getStatus() {
        return status;
    }
