...
import kr.co.kevit.ocpp201.enumtype.TariffSetStatusEnumType;
...
public class SetDefaultTariff {
     ...
     * required
     */
    private TariffSetStatusEnumType status;

    private StatusInfoType statusInfo;

    private Map<String, Object> customData;

    public TariffSetStatusEnumType getStatus() {
        return status;
    }

    public void setStatus(TariffSetStatusEnumType status) {
        this.status = status;
    }
