...
/**
 * 배터리 교환 충전기 화면 Controller (충전기 전체 목록 화면)
 *
 * @author BCKim <a href="mailto:bckim@kevit.co.kr">bckim@kevit.co.kr</a>
 * @since 2026. 5. 13.
 */
@Controller
@RequestMapping("batterySwap/station")
public class BatterySwapStationController {

    private static final Logger LOGGER = LoggerFactory.getLogger(BatterySwapStationController.class);
    ...
    public String batterySwapStationList(HttpServletRequest req) {
        LOGGER.debug("/batterySwap/station/list");
        registerAccessLog(req, "/batterySwap/station/list");
        return "batteryswap/batterySwapStationList";
    }
