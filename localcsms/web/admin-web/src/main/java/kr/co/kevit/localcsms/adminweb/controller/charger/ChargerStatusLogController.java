 ...
 */
@Controller
@RequestMapping("charger/statusLog")
public class ChargerStatusLogController {
    ...
    public ModelAndView statusLogList(HttpServletRequest req, String cpCsId) {
        //
        registerAccessLog(req, "/charger/statusLog/list");
        ModelAndView mav = new ModelAndView("charger/statusLog/statusLogList");
        return mav;
    }
