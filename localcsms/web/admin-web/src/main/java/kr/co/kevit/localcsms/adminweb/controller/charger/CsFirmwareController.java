...
/**
 * TB_CHFW001 - 충전기 펌웨어 업데이트 페이지 Controller
 * GET /charger/firmware/list - 목록 페이지
 */
@Controller
@RequestMapping("charger/firmware")
public class CsFirmwareController {

    private static final Logger LOGGER = LoggerFactory.getLogger(CsFirmwareController.class);
    ...
    public ModelAndView list(HttpServletRequest req,
        ...
        LOGGER.debug("/charger/firmware/list cpId={} csId={}", cpId, csId);
        registerAccessLog(req, "/charger/firmware/list");
        ModelAndView mav = new ModelAndView("charger/firmware/list");
