 ...
 */
@Controller
@RequestMapping("charger/swapSlot")
public class SwapSlotStatusController {
    ...
    public String swapSlotStatusList(HttpServletRequest req) {
        LOGGER.debug("/charger/swapSlot/list");
        registerAccessLog(req, "/charger/swapSlot/list");
        return "charger/swapSlot/swapSlotStatusList";
    }

    @RequestMapping(value = "/his/list", method = RequestMethod.GET)
    @Secured({ "ROLE_OPER", "ROLE_ADMIN" })
    public String swapSlotStatusHisList(HttpServletRequest req) {
        LOGGER.debug("/charger/swapSlot/his/list");
        registerAccessLog(req, "/charger/swapSlot/his/list");
        return "charger/swapSlot/swapSlotStatusHisList";
    }
