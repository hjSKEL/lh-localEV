 ...
 */
@Controller
@RequestMapping("reCustomerCard")
public class ReCustomerCardController {

    private static final Logger LOGGER = LoggerFactory.getLogger(ReCustomerCardController.class);
    ...
    public String customerCardList(HttpServletRequest req) {
        //
        LOGGER.debug("/reCustomerCard/list");
        registerAccessLog(req, "/reCustomerCard/list");
        return "customer/reCustomerCardList";
    }
