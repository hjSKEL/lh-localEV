...
public class PrepaidCardController {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(PrepaidCardController.class);
    ...
    public String prepaidCardList(HttpServletRequest req) {
        LOGGER.debug("/prepaidCard/list");
        registerAccessLog(req, "/prepaidCard/list");
        return "payment/prepaidCardList";
    }

    @RequestMapping(value = "/his/list", method = RequestMethod.GET)
    @Secured({ "ROLE_OPER", "ROLE_ADMIN" })
    public String prepaidCardHisList(HttpServletRequest req) {
        LOGGER.debug("/prepaidCard/his/list");
        registerAccessLog(req, "/prepaidCard/his/list");
        return "payment/prepaidCardHisList";
    }
