...
public class ReservationController {
    ...
    public String reservationList(HttpServletRequest req) {
        LOGGER.debug("/reservation/list");
        registerAccessLog(req, "/reservation/list");
        return "recharging/reservation/list";
    }

    @RequestMapping(value = "/detail", method = RequestMethod.GET)
    @Secured({ "ROLE_ADMIN", "ROLE_OPER" })
    public String reservationDetail(HttpServletRequest req) {
        LOGGER.debug("/reservation/detail");
        registerAccessLog(req, "/reservation/detail");
        return "recharging/reservation/detail";
    }
