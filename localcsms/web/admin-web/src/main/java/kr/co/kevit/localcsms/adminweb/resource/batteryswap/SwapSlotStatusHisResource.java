 ...
 */
@RestController
@RequestMapping("ws/batterySwap/slot/his")
public class SwapSlotStatusHisResource extends AbstractResource {
    ...
    public Page<SwapSlotStatusHisDto> searchHisList(SwapSlotStatusHisSearchCond searchCond, HttpServletRequest request) {
        ...
        LOGGER.info("[REQ] USER ID :{}, ACCESS_IP:{}, URL : ws/batterySwap/slot/his, GET, DATA : {}",
        ...
        try {
            ...
            LOGGER.info("[RES] USER ID :{}, ACCESS_IP:{}, URL : ws/batterySwap/slot/his, GET, SUCCESS",
                    loginUser.getUserId(), accessIp);
        } catch (Exception ex) {
            LOGGER.info("[RES] USER ID :{}, ACCESS_IP:{}, URL : ws/batterySwap/slot/his, GET, FAIL",
                    loginUser.getUserId(), accessIp);
