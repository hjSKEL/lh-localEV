 ...
 */
@RestController
@RequestMapping("ws/charger/swapSlot")
public class SwapSlotStatusResource extends AbstractResource {
    ...
    public Page<SwapSlotStatusDto> searchSlotList(SwapSlotStatusSearchCond searchCond, HttpServletRequest request) {
        ...
        LOGGER.info("[REQ] USER ID :{}, ACCESS_IP:{}, URL : ws/charger/swapSlot, GET, DATA : {}",
        ...
        try {
            ...
            LOGGER.info("[RES] USER ID :{}, ACCESS_IP:{}, URL : ws/charger/swapSlot, GET, SUCCESS",
                    loginUser.getUserId(), accessIp);
        } catch (Exception ex) {
            LOGGER.info("[RES] USER ID :{}, ACCESS_IP:{}, URL : ws/charger/swapSlot, GET, FAIL",
                    loginUser.getUserId(), accessIp);
    ...
    public Map<String, Integer> searchSlotCountByState(SwapSlotStatusSearchCond searchCond, HttpServletRequest request) {
        User loginUser = SessionManager.getLoginUser();
        String accessIp = getAccessIp(request);
        LOGGER.info("[REQ] USER ID :{}, ACCESS_IP:{}, URL : ws/charger/swapSlot/count-by-state, GET, DATA : {}",
                loginUser.getUserId(), accessIp, new Gson().toJson(searchCond));
        try {
            ...
            LOGGER.info("[RES] USER ID :{}, ACCESS_IP:{}, URL : ws/charger/swapSlot/count-by-state, GET, SUCCESS",
                    loginUser.getUserId(), accessIp);
            return result;
        } catch (Exception ex) {
            LOGGER.info("[RES] USER ID :{}, ACCESS_IP:{}, URL : ws/charger/swapSlot/count-by-state, GET, FAIL",
                    loginUser.getUserId(), accessIp);
            LOGGER.error(ex.getMessage(), ex);
            return null;
        }
    ...
    public SwapSlotStatus searchSlotDetail(@PathVariable("cpId") String cpId,
        ...
        User loginUser = SessionManager.getLoginUser();
        String accessIp = getAccessIp(request);
        LOGGER.info("[REQ] USER ID :{}, ACCESS_IP:{}, URL : ws/charger/swapSlot/{}/{}/{}, GET",
