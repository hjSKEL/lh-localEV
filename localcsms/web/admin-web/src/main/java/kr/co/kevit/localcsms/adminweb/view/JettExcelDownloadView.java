 ...
 * @since 2018. 12. 14.
 */
public class JettExcelDownloadView extends AbstractXlsView {

    private static final Logger LOGGER = LoggerFactory.getLogger(JettExcelDownloadView.class);

    private String template;
    private String fileName;

    public JettExcelDownloadView(String template, String fileName) {
    ...
    protected void buildExcelDocument(Map<String, Object> modal, Workbook workbook, HttpServletRequest request,
        ...
        try {
            ...
            excel = transformer.transform(is, modal);
