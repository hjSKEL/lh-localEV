...
public class ExcelTransformer
{
    ...
    {
        logger.debug("Transforming file \"{}\" into file \"{}\".", inFilename, outFilename);
        ...
        logger.debug("Done transforming file \"{}\" into file \"{}\".", inFilename, outFilename);
    }
    ...
    public Workbook transform(InputStream is, Map<String, Object> beans)
            throws IOException, InvalidFormatException
    {
        logger.debug("Creating a Workbook from an InputStream.");
    ...
    {
        logger.debug("Transforming a Workbook.");
        ...
        logger.debug("Done transforming a Workbook.");
    }
    ...
    public void transform(String inFilename, String outFilename, List<String> templateSheetNamesList,
            ...
            throws IOException, InvalidFormatException
    {
        logger.debug("Transforming file \"{}\" into file \"{}\" with Sheet Specific Beans.", inFilename, outFilename);
        try (FileOutputStream fileOut = new FileOutputStream(outFilename);
        ...
        logger.debug("Done transforming file \"{}\" into file \"{}\" with Sheet Specific Beans.", inFilename, outFilename);
    }
    ...
    public Workbook transform(InputStream is, List<String> templateSheetNamesList,
            ...
            throws IOException, InvalidFormatException
    {
        logger.debug("Creating a Workbook from an InputStream with Sheet Specific Beans.");
        Workbook workbook = WorkbookFactory.create(is);
    ...
    public void transform(Workbook workbook, List<String> templateSheetNamesList,
                          List<String> newSheetNamesList, List<Map<String, Object>> beansList)
    {
        logger.debug("Transforming a Workbook with Sheet Specific Beans.");
        ...
        postTransformation(workbook, context, sheetTransformer);
        logger.debug("Done transforming a Workbook with Sheet Specific Beans.");
    }
