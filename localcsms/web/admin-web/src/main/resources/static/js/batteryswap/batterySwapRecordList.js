...
var batterySwapRecordListJs = function () {
    ...
    function _search() {
        ...
        $.ajax({
            type: 'GET',
            url: _ctx + "/ws/batterySwap/record" + p,
            dataType: 'json',
            success: _display,
            error: function (xhr) { parent.layerJs.fn_exception(xhr); }
        });
    ...
    function _searchByRequestId(reqId) {
        $.ajax({
            type: 'GET',
            url: _ctx + "/ws/batterySwap/record/" + encodeURIComponent(reqId),
            dataType: 'json',
    ...
    function _openDetail(requestId) {
        self.location = _ctx + "/batterySwap/record/detail?requestId=" + encodeURIComponent(requestId);
    }
