...
var swapSlotStatusListJs = function () {
    ...
    function _search() {
        ...
        $.when(
            $.ajax({ type: 'GET', url: _ctx + "/ws/charger/swapSlot" + p, dataType: 'json' }),
            $.ajax({ type: 'GET', url: _ctx + "/ws/charger/swapSlot/count-by-state" + pCount, dataType: 'json' })
    ...
    function _openDetail(cpId, csId, evseId) {
        ...
        $.ajax({
            type: 'GET',
            url: _ctx + "/ws/charger/swapSlot/" + encodeURIComponent(cpId) + "/" + encodeURIComponent(csId) + "/" + encodeURIComponent(evseId),
            dataType: 'json',
            success: _fillModal,
            error: function (xhr) { parent.layerJs.fn_exception(xhr); }
        });
    ...
    function _viewAllHistory() {
        ...
        self.location = _ctx + "/charger/swapSlot/his/list"
