...
public class LogStatusNotificationBean implements ControlerBean {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(LogStatusNotificationBean.class);
    ...
    public Object control(String csId, List<Object> reqs) {
        ...
        if(LOGGER.isDebugEnabled()) {
            LOGGER.debug("LogStatusNotificationBean CSID : {}", csId);        
            Object object = reqs.get(3);
            Gson gson = new Gson();
            String text = gson.toJson(object);
            kr.co.kevit.ocpp16.request.LogStatusNotification request = gson.fromJson(text,kr.co.kevit.ocpp16.request.LogStatusNotification.class);
