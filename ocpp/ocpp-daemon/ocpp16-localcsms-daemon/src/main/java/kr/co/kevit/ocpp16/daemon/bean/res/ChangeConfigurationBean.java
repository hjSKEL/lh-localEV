 ...
 * @since 2019. 6. 28.
 */
public class ChangeConfigurationBean implements ControlerBean {
    ...
    public Object control(String csId, List<Object> res) {
        ...
        if (LOGGER.isDebugEnabled()) {
            ...
            kr.co.kevit.ocpp16.response.ChangeConfiguration response = gson.fromJson(text,kr.co.kevit.ocpp16.response.ChangeConfiguration.class);
