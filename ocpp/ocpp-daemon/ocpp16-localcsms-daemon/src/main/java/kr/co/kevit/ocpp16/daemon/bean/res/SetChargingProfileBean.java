 ...
 * @since 2019. 6. 30.
 */
public class SetChargingProfileBean  implements ControlerBean {
    
    private static final Logger LOGGER = LoggerFactory.getLogger(SetChargingProfileBean.class);
    ...
    public Object control(String csId, List<Object> res) {
        ...
        kr.co.kevit.ocpp16.response.SetChargingProfile response = gson.fromJson(text,kr.co.kevit.ocpp16.response.SetChargingProfile.class);
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("SetChargingProfileBean.getStatus : {}", response.getStatus());
        }
        ...
        case Accepted:
            datum.setEventCode("EVTR01");
            break;
        case Rejected:
            datum.setEventCode("EVTR02");
            break;
        case NotSupported:
            datum.setEventCode("EVTR03");
            break;
        }
